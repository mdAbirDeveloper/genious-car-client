    ...
    return (
            <div id={`slide${slide.id}`} className="carousel-item relative w-full">
                <div className='carousel-img'>
                    <img src={slide.image} alt='' className="carousel-height rounded-xl" />
                </div>
                ...
                <div className="absolute w-1/2 flex justify-end transform -translate-y-1/2 left-24  top-1/2">
                    <p className='text-xl  font-bold text-white'>
                        There are many variations of passages of  available, but
                        the majority have suffered alteration in some form
                    </p>
                </div>
                <div className="absolute w-1/2 flex justify-start transform -translate-y-1/2 left-24  top-3/4">
